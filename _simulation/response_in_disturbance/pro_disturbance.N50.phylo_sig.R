...
pro_Eh <- 20    #Add pro-enviromental heterogeneity at round pro_Eh_round
...
pro_Eh <- 20
l=4
phy_sig <- seq(0,0.2,0.02)
vars <- expand.grid(l,phy_sig)
colnames(vars) <- c("l","phy_sig")
#=================
set.seed(111)
Per <- 100
cpu=40
...
stopCluster(cl)
#=====================================
save(variable_Nspecies,vars,file="Pro_disturbance.N50.phy_sig.Rdata")